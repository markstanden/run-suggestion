...
public static class TestData
{
    ...
    public static class FourWeekRunLoads
    {
        ...
        {
            public static readonly int[] NoVariance = [5000, 5000, 5000, 5000];
            public static readonly int[] LowVariance = [6000, 4000, 5500, 4500];
            public static readonly int[] HighVariance = [7500, 2500, 7000, 3000];
            public static readonly int[] Progression = [5500, 5250, 4750, 4500];
            public static readonly int[] Decreasing = [4500, 4750, 5250, 5500];
        }

        public static class TenKmAverage
        {
            public static readonly int[] NoVariance = [10000, 10000, 10000, 10000];
            public static readonly int[] LowVariance = [12000, 8000, 11000, 9000];
            public static readonly int[] HighVariance = [15000, 5000, 14000, 6000];
            public static readonly int[] Progression = [11000, 10500, 9500, 9000];
            public static readonly int[] Decreasing = [9000, 9500, 10500, 11000];
        }

        public static class TwentyKmAverage
        {
            public static readonly int[] NoVariance = [20000, 20000, 20000, 20000];
            public static readonly int[] LowVariance = [24000, 16000, 22000, 18000];
            public static readonly int[] HighVariance = [30000, 10000, 28000, 12000];
            public static readonly int[] Progression = [22000, 21000, 19000, 18000];
            public static readonly int[] Decreasing = [18000, 19000, 21000, 22000];
        }
    }
}
